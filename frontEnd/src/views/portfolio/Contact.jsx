...
export default function Contact() {
    ...
    const submitContact = async (e) => {
        ...
        if (isVerified) {
            ...
            setContactError({
                verified: ["Please verify that you are not a robot"],
            });
        }
    };
            ...
            <div className="biodata-contact">
                ...
                <div className="form-input space-y-1 ">
                    <div className="sm:col-span-4">
                        <label
                            className={`${
                                contactError?.name ? `text-red-600 ` : ``
                    ...
                    <div className="sm:col-span-4">
                        <label
                            className={`${
                                contactError?.email ? `text-red-600 ` : ``
                            }block text-lg font-medium leading-6`}
                        >
                            Email address
                        </label>
                    ...
                    <div className="sm:col-span-4">
                        <label
                            className={`${
                                contactError?.phoneNumber ? `text-red-600 ` : ``
                            }block text-lg font-medium leading-6`}
                        >
                            Phone number
                        </label>
                    ...
                    <div className="sm:col-span-4">
                        <label
                            className={`${
                                contactError?.message ? `text-red-600 ` : ``
                            }block text-lg font-medium leading-6`}
                        >
                            Message
                        </label>
                    ...
                    <div className="flex m-auto justify-center pb-4">
                        {contactError?.verified?.map((error) => (
                            <p
                                key={error}
                                className="text-sm text-red-600 dark:text-red-500"
                            >
